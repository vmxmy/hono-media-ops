...
// Generated at: 2026-01-15T04:57:46.297Z
...
export const COMPONENT_DEFINITIONS: A2UIComponentDefinition[] = [
  ...
  },
  {
    ...
    description: "Markdown editor with toolbar and live preview",
    category: "interactive",
    properties: {
      value: {
        type: "string",
      ...
      preview: {
        type: "string",
        description: "Preview mode: edit (no preview), live (side by side), preview (read only)",
        enum: ["edit","live","preview"],
        default: "edit",
      },
      hideToolbar: {
        type: "boolean",
  ...
  },
  {
    ...
    description: "Material swipe selector",
    category: "custom",
    properties: {
      items: {
        type: "array",
